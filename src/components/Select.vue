...
.items div:hover {
  background: linear-gradient(to right, scale-color($theme1, $lightness: 50%), scale-color($theme2, $lightness: 50%));
}
...
.dark {
  ...
  .highlightedOption {
    background: linear-gradient(to right, $theme1Dark, $theme2Dark) !important;
    color: #333 !important;
  }

  .items div:hover {
    background: linear-gradient(to right, scale-color($theme1, $lightness: 25%), scale-color($theme2, $lightness: 25%));
    color: #333;
  }
}
</style>
